...
import com.revolveteam.atak.peat.model.PeatRole
import com.revolveteam.atak.peat.model.PeatTrack
import com.revolveteam.atak.peat.model.CommsQuality
import com.revolveteam.peat.PeatMarker
import com.revolveteam.peat.PeatPeer as BlePeer
...
class PeatDropDownReceiver(
    ...
    companion object {
        ...
        const val SHOW_PLUGIN = "com.revolveteam.atak.peat.SHOW_PLUGIN"
    }
    ...
    private fun buildPlatformDetailView(platform: PeatPlatform): LinearLayout {
        ...
        platform.sensorStatus?.forEach { (sensor, status) ->
            val sensorColor = when (status) {
                com.revolveteam.atak.peat.model.SensorStatus.ACTIVE -> Color.parseColor("#4CAF50")
                com.revolveteam.atak.peat.model.SensorStatus.IDLE -> Color.parseColor("#2196F3")
                com.revolveteam.atak.peat.model.SensorStatus.DEGRADED -> Color.parseColor("#FFC107")
                com.revolveteam.atak.peat.model.SensorStatus.OFFLINE -> Color.parseColor("#F44336")
                com.revolveteam.atak.peat.model.SensorStatus.UNKNOWN -> Color.GRAY
            }
