...
/**
 * Represents a HIVE cell (squad/team) for display in ATAK.
 *
 * A cell is a group of autonomous platforms that coordinate via the HIVE protocol.
...
data class HiveCell(
     ...
     */
    fun toCotUid(): String = "HIVE-CELL-$id"
