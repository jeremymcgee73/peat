...
The HIVE M1 POC includes an ONNX-based inference pipeline for object detection. It supports multiple execution providers:
...
```bash
export ORT_LIB_LOCATION=/home/kit/Code/hive-m1-poc/onnxruntime-gpu/onnxruntime/capi
...
```rust
use hive_inference::inference::ExecutionProvider;
