//! HIVE Beacon Registration Example
//!
//! Demonstrates registering an edge device with the HIVE network,
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("HIVE Beacon Registration");
    println!("========================");
    println!();
    ...
    let beacon = HiveBeacon::new(config)?;
    println!();
    ...
    println!();
    println!("Beacon ready for HIVE network integration!");
    println!();
    println!("Next steps:");
    println!("  1. Connect to HIVE mesh using AutomergeIrohBackend");
