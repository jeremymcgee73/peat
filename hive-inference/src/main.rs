...
fn main() {
    ...
    tracing::info!("HIVE M1 POC - Object Tracking Demo");

    // Create a coordinator for formation-level aggregation
    // Note: In a real deployment, the HIVE protocol's CRDT mesh handles
    ...
    // In production, teams are discovered via HIVE mesh document sync
