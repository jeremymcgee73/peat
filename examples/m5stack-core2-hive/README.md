# HIVE Protocol - M5Stack Core2 Demo

Demonstration of HIVE-Lite mesh networking on ESP32 using BLE.
...
cd examples/m5stack-core2-hive
...
1. **Advertises** as a HIVE node via BLE beacons
2. **Exposes** GATT service with HIVE characteristics
...
- Service UUID: `0xF47A` (16-bit alias for HIVE)
...
2. Install HIVE ATAK plugin on Android tablet
3. Scan for HIVE nodes
...
# Use explicit port
espflash flash --port /dev/tty.usbserial-xxxxx target/xtensa-esp32-espidf/release/m5stack-core2-hive
```
