//! HIVE Protocol Ontology
//!
//! This module defines the semantic vocabulary and relationships for the HIVE Protocol.
//! It provides:
...
/// Build the HIVE Protocol domain ontology
pub fn build_cap_ontology() -> Ontology {
    ...
    ont.add_concept(
        Concept::new("node", "Node", ConceptCategory::Entity)
            .with_description("A node in the HIVE Protocol network (platform or system)"),
    );
