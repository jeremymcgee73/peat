# HIVE Protocol Interface Control Document (ICD)
...
- HIVE Protocol implementations (Rust, Python, Java, C++)
...
| SCHEMAS.md | HIVE Protocol Schema Reference | 1.0 | 2025-11-06 |
| README.md | hive-schema Documentation | 1.0 | 2025-11-06 |
...
### 2.1 HIVE Protocol Architecture
...
└─────────────────────┬───────────────────────────────────────┘
                      ...
                      ↓
┌─────────────────────────────────────────────────────────────┐
│              HIVE Protocol Implementations                    │
│    (hive-protocol, hive-transport, hive-persistence)           │
└─────────────────────────────────────────────────────────────┘
```
...
HIVE Protocol uses **Conflict-free Replicated Data Types (CRDTs)** for distributed consistency.
...
```
https://github.com/<org>/hive/tree/main/hive-schema/proto/
```
...
**Copyright**: © 2025 HIVE Protocol Contributors
