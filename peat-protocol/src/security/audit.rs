//! # Audit Logging Module - Security Event Tracking for Peat Protocol
//!
...
//!
//! ```ignore
//! use peat_protocol::security::{AuditLogger, FileAuditLogger, AuditEventType};
//!
//! // Create file-based audit logger
//! let logger = FileAuditLogger::new("/var/log/peat/audit.log")?;
//!
