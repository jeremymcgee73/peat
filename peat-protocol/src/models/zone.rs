...
//!
//! This module uses protobuf types from `peat_schema::zone::v1` for multi-transport
...
pub use peat_schema::zone::v1::{ZoneConfig, ZoneState, ZoneStats};
...
impl ZoneStateExt for ZoneState {
    ...
    fn stats(&self) -> ZoneStats {
        ...
        ZoneStats {
            ...
            calculated_at: Some(peat_schema::common::v1::Timestamp {
                seconds: SystemTime::now()
                    .duration_since(UNIX_EPOCH)
                    .unwrap()
                    .as_secs(),
