...
//! helping make an evidence-based decision between backends for the Peat Protocol.
//!
//! Run with:
...
use peat_protocol::models::cell::{CellConfig, CellConfigExt, CellState, CellStateExt};
use peat_protocol::models::node::{NodeConfig, NodeConfigExt};
use peat_protocol::sync::{BackendConfig, DataSyncBackend, Document, TransportConfig, Value};
    ...
    for doc_count in [10, 100].iter() {
        ...
        group.bench_with_input(
            ...
            |b, &count| {
                ...
                b.iter(|| {
                    let query = peat_protocol::sync::Query::All;
                    let results = rt
