...
//!
//! These tests validate the Peat Protocol's behavior under network partition scenarios:
...
use peat_protocol::models::{CellConfigExt, CellStateExt};
...
// test provides sufficient validation of partition recovery for the Peat protocol.
