...
impl EventTransmitter {
    ...
    pub fn enqueue(&mut self, event: HiveEvent) -> bool {
    ...
    pub fn transmit(&mut self, max_events: usize) -> Vec<HiveEvent> {
    ...
    pub fn transmit_critical(&mut self) -> Vec<HiveEvent> {
    ...
    fn get_level(&self, event: &HiveEvent) -> usize {
        let priority = event
            .routing
            .as_ref()
...
fn estimate_event_size(event: &HiveEvent) -> usize {
...
mod tests {
    ...
    fn make_event(id: &str, priority: EventPriority, payload_size: usize) -> HiveEvent {
        HiveEvent {
