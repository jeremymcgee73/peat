...
//!
//! ```ignore
//! use hive_protocol::hierarchy::maintenance::{HierarchyMaintainer, RebalanceAction};
//! use hive_protocol::models::cell::{CellState, CellStateExt, CellConfig, CellConfigExt};
//!
//! # fn example() -> hive_protocol::Result<()> {
...
///
/// ```no_run
/// use hive_protocol::hierarchy::maintenance::{RebalancingCoordinator, HierarchyMaintainer};
/// use hive_protocol::hierarchy::RoutingTable;
