...
//! enabling HIVE Protocol to work with multiple sync engines without changing
//! business logic.
//!
//! ## Architecture
//!
...
//!
//! ```rust,ignore
//! use hive_protocol::sync::{DataSyncBackend, BackendConfig};
...
//!
//! ```rust,ignore
//! use hive_protocol::sync::mock::MockBackend;
//!
//! # async fn test_example() {
//! let backend = MockBackend::new();
//! // Test HIVE protocol logic with mock backend
//! # }
//! ```
//!
//! ## Design Rationale
