//! HIVE-specific packet aggregation for hierarchical telemetry summarization
//!
...
//! # Architecture
//!
//! The PacketAggregator implements `hive_mesh::routing::Aggregator` and:
...
use hive_mesh::routing::{AggregationError, Aggregator, DataDirection, DataPacket, DataType};
...
/// HIVE-specific packet aggregator for hierarchical telemetry summarization
///
