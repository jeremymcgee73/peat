...
//!
//! This module provides conversions between HIVE Protocol protobuf types
...
#[cfg(feature = "automerge-backend")]
use hive_schema::cell::v1::CellState;
#[cfg(feature = "automerge-backend")]
...
mod tests {
    ...
    use hive_schema::cell::v1::CellConfig;
    ...
    fn test_node_state_roundtrip() {
        ...
        use hive_schema::node::v1::{HealthStatus, Phase};
