...
//! capabilities in the HIVE protocol. It shows:
//!
...
use hive_protocol::storage::ditto_store::DittoStore;
use hive_protocol::{Error, Result};
...
async fn main() -> Result<()> {
    ...
    info!("=== HIVE Protocol Error Handling Example ===");
