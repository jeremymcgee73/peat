//! PEAT Commander - Intent-Based Command TUI
//!
//! A turn-based tactical game demonstrating PEAT's hierarchical command concept:
//! - Commander sees COMPOSED CAPABILITIES, not individual pieces
//! - Commander sets INTENT through objectives
//! - PEAT generates COURSES OF ACTION (COAs)
//! - Pieces execute AUTONOMOUSLY based on chosen COA
//!
//! Run with: cargo run -p peat-commander
