...
```bash
# Instead of:
cat cap-sim/e8-performance-results-20251107-224100/EXECUTIVE-SUMMARY.md

# Now use:
cat cap-sim/e8-performance-results-latest/EXECUTIVE-SUMMARY.md
```
...
2. Wait 22 minutes
3. Find results: ls -lrt cap-sim/ | grep e8-performance  # Which one?
4. Open: cat cap-sim/e8-performance-results-20251107-224100/E8-THREE-WAY-COMPARISON.md
...
1. Run: make e8-performance-tests
2. Wait 22 minutes
3. View: cat cap-sim/e8-performance-results-latest/EXECUTIVE-SUMMARY.md
