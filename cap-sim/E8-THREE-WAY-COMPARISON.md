...
This document outlines the strategy for measuring CAP Protocol's performance impact and benefits through a comprehensive three-way comparison across bandwidth-constrained networks.
...
**Behavior:**
- Pure Ditto SDK without CAP Protocol layer
...
**Behavior:**
- CAP Protocol layer on top of Ditto
...
**Purpose:** Measures pure CAP Protocol overhead without differential update benefits
...
**What This Measures:** Pure cost of CAP Protocol authorization
...
- `cap_sim_node` - CAP Protocol (configurable filtering)
