...
```protobuf
// New file: cap-schema/proto/aggregation.proto
...
**Philosophy**: **"CAP Protocol provides mechanism, integrators provide policy"** - this principle should apply **both ways** (upward AND downward)
