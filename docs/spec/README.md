...
This directory contains formal protocol specifications for HIVE (Hierarchical Intelligence for Virtual Environments). These documents are intended to evolve toward IETF RFC-style specifications suitable for public review and interoperability testing.
