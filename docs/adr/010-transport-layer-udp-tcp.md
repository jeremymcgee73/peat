...
Extend CAP protocol to support both UDP and TCP transports, with explicit application control over which transport is used for each message type.
...
1. ADR-001: CAP Protocol POC Architecture
