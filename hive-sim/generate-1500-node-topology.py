#!/usr/bin/env python3
"""Generate a 1500-node Traditional Baseline topology for Containerlab."""

def generate_topology(node_count=1500):
    lines = [
        f"name: traditional-battalion-{node_count}node",
        "",
        "# 1500-node topology - pushing beyond practical limits",
        "mgmt:",
        "  network: clab",
...
if __name__ == "__main__":
    topology = generate_topology(1500)
    output_file = "topologies/traditional-battalion-1500node.yaml"
