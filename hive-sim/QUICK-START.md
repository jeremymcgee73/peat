...
### Required Setup
- ✅ **Docker Image Built** - `hive-sim-node:latest` must exist
...
docker image ls hive-sim-node  # Verify image exists
...
**Results location:**
```bash
hive-sim/e8-performance-results-latest/
```
...
### Main Summary Report
```bash
cat hive-sim/e8-performance-results-latest/E8-THREE-WAY-COMPARISON.md
```

### Architecture-Specific Summaries
```bash
# Traditional IoT results
cat hive-sim/e8-performance-results-latest/1-traditional-iot-baseline/COMPREHENSIVE_SUMMARY.md

# CAP Full Replication results
cat hive-sim/e8-performance-results-latest/2-cap-full-replication/COMPREHENSIVE_SUMMARY.md

# CAP Differential results
cat hive-sim/e8-performance-results-latest/3-cap-differential/COMPREHENSIVE_SUMMARY.md
```

### Detailed Metrics
```bash
# View metrics for specific test
cat hive-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_summary.txt

# View JSON metrics
jq . hive-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_metrics.json
```

### Per-Node Logs
```bash
# View logs for specific node
cat hive-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_soldier-1.log
```
...
- **Detailed Optimization Plan:** `hive-sim/E8-OPTIMIZATION-PLAN.md`
- **Baseline Requirements:** `hive-sim/BASELINE-TESTING-REQUIREMENTS.md`
- **Traditional IoT Design:** `hive-sim/TRADITIONAL-BASELINE-DESIGN.md`
- **Main README:** `hive-sim/README.md`
