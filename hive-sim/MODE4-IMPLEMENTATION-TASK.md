...
**File:** `hive-protocol/examples/cap_sim_node.rs`
...
**File:** `hive-sim/topologies/platoon-24node-client-server-mode4.yaml`
...
1. `hive-protocol/examples/cap_sim_node.rs` - Main integration work
2. `hive-sim/topologies/platoon-24node-client-server-mode4.yaml` - New topology
3. `hive-sim/test-four-way-comparison.sh` - Optional: extend test script
...
- hive-protocol/src/storage/HIERARCHICAL_SUMMARIES.md - Storage API docs
- hive-schema/proto/hierarchy.proto - Protobuf types
