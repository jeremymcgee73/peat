//! CAP Protocol Ontology
//!
//! This module defines the semantic vocabulary and relationships for the CAP Protocol.
//! It provides:
...
/// Build the CAP Protocol domain ontology
pub fn build_cap_ontology() -> Ontology {
    ...
    ont.add_concept(
        Concept::new("node", "Node", ConceptCategory::Entity)
            .with_description("A node in the CAP Protocol network (platform or system)"),
    );
