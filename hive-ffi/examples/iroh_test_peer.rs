...
//! # What it does
//!
//! 1. Creates a HiveNode with FUNCTEST credentials and fixed port 42009
...
//!
//! ```bash
//! CXXFLAGS="-include cstdint" cargo run --example iroh_test_peer -p hive-ffi --features sync
//! ```
...
fn main() {
    ...
    let storage_path =
        std::env::var("HIVE_STORAGE_PATH").unwrap_or_else(|_| "/tmp/hive-iroh-test-peer".into());
