...
#[cfg(feature = "onnx-inference")]
use peat_inference::messages::TrackUpdate;
...
#[cfg(feature = "onnx-inference")]
fn resize_frame(
    frame: &peat_inference::inference::VideoFrame,
    target_width: u32,
    target_height: u32,
) -> peat_inference::inference::VideoFrame {
    use peat_inference::inference::VideoFrame;
...
/// In production, this would be replaced with ConnectedPipeline + PeatSyncClient
#[cfg(feature = "onnx-inference")]
struct SyncTracker {
    #[allow(dead_code)]
    platform_id: String,
