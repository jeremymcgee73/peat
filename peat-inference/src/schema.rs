//! Schema conversion module for Peat Protocol integration
//!
...
//!
//! ```rust,ignore
//! use peat_inference::schema::{ToProtoCapability, ToProtoTrack};
//! use peat_inference::messages::CapabilityAdvertisement;
//!
...
// Re-export peat-schema types for convenience
pub use peat_schema::capability::v1::{
...
pub use peat_schema::common::v1::{Position as ProtoPosition, Timestamp as ProtoTimestamp};
pub use peat_schema::track::v1::{
