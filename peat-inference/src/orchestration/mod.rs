...
//!
//! ```rust,ignore
//! use peat_inference::orchestration::{UpdateCoordinator, RolloutConfig, UpdateRequest};
//! use peat_inference::orchestration::runtime::{RuntimeAdapter, ArtifactType, SimulatedAdapter};
//!
