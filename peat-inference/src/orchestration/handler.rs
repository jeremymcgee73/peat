...
//!
//! This module bridges Peat protocol's `DeploymentDirective` with the
//! `OrchestrationService`, handling the conversion and lifecycle management.
//!
//! ## Flow
//!
//! ```text
//! DeploymentDirective (peat-protocol)
//!         │
//!         ▼
...
//!         │
//!         ▼
//! DeploymentStatus (peat-protocol)
//! ```
...
mod tests {
    use super::*;
    use peat_protocol::distribution::{ArtifactSpec, DeploymentScope, DeploymentState};
