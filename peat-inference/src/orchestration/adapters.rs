...
///
/// ```rust,ignore
/// use peat_inference::orchestration::adapters::OnnxRuntimeAdapter;
/// use peat_inference::orchestration::runtime::ArtifactType;
///
...
///
/// ```rust,ignore
/// use peat_inference::orchestration::adapters::ContainerAdapter;
/// use peat_inference::orchestration::runtime::ArtifactType;
///
...
///
/// ```rust,ignore
/// use peat_inference::orchestration::adapters::ProcessAdapter;
/// use peat_inference::orchestration::runtime::ArtifactType;
///
