...
//! This module integrates with peat-protocol's cell module for:
...
use peat_protocol::cell::election_policy::{
...
use peat_protocol::models::{
    AuthorityLevel as PeatAuthorityLevel, BindingType, Capability, CapabilityType, CellRole,
...
/// Convert local AuthorityLevel to peat-protocol AuthorityLevel
...
/// Team formation manager that wraps peat-protocol's CellCoordinator
...
impl TeamFormation {
    ...
    pub fn check_formation_complete(&mut self) -> Result<bool, peat_protocol::Error> {
        self.coordinator
...
impl Team {
    ...
    /// Form the team using peat-protocol's cell formation
    ///
    ...
    pub fn form_team(&mut self) -> Result<bool, peat_protocol::Error> {
    ...
    pub fn get_capability_summary(&self) -> TeamCapabilitySummary {
        ...
        // Calculate readiness score using peat-protocol
        let readiness_score = {
