...
impl SensorCapability {
    ...
    pub fn to_proto_sensor_spec(&self, sensor_id: &str) -> peat_schema::sensor::v1::SensorSpec {
        use crate::schema_convert::SensorCapabilityProtoExt;
        self.to_sensor_spec(sensor_id)
    }

    /// Create from proto SensorSpec
    pub fn from_proto(proto: &peat_schema::sensor::v1::SensorSpec) -> Self {
        proto.into()
    }
}
...
impl VehiclePlatform {
    ...
    pub fn sensors_as_proto(&self) -> Vec<peat_schema::sensor::v1::SensorSpec> {
        self.sensors
            .iter()
            .enumerate()
